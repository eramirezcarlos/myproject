...
if [ -d "/workspace/myproject/backend" ] && [ -f "/workspace/myproject/backend/artisan" ]; then
    cd /workspace/myproject/backend
    echo -e "Laravel: $(php artisan --version | grep -o '[0-9]\+\.[0-9]\+\.[0-9]\+')"
    cd /workspace
fi
if [ -d "/workspace/myproject/frontend" ] && [ -f "/workspace/myproject/frontend/package.json" ]; then
    cd /workspace/myproject/frontend
...
start_laravel() {
    if [ -d "/workspace/myproject/backend" ]; then
        cd /workspace/myproject/backend
...
start_nextjs() {
    if [ -d "/workspace/myproject/frontend" ]; then
        cd /workspace/myproject/frontend
