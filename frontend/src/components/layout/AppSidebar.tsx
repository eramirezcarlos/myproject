...
const navigation = [
  ...
  { name: 'Authentication', href: '/auth', icon: LockIcon },
...
function TaskIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3-6h.008v.008H15.75V12H15zm0 3h.008v.008H15.75V15H15zm0 3h.008v.008H15.75V18H15zM6.75 6.75v10.5a.75.75 0 0 0 .75.75h9a.75.75 0 0 0 .75-.75V6.75a.75.75 0 0 0-.75-.75h-9a.75.75 0 0 0-.75.75z" />
    </svg>
  );
}
